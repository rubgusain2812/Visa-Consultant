<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewZealand.aspx.cs" Inherits="VisaUser_NewZealand" %>
        ...
        <div class="imagediv" align="center">
            ...
            <div id="slider2_container" style="position: relative; width: 1000px; height: 300px;">
                ...
                <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px;
                    ...
                    <div>
                        <a u="image" href="#">
                            <img src="Images/image%20of%20new%20zealand/new-zealand-home.jpg" />
                        </a>
                    </div>
                    <div>
                        <a u="image" href="#">
                            <img src="Images/image%20of%20new%20zealand/newzealandtourist2.jpg" />
                        </a>
                    </div>
                    <div>
                        <a u="image" href="#">
                            <img src="Images/image%20of%20new%20zealand/newzealandstudy2.jpg" />
                        </a>
                    </div>
                    <div>
                        <a u="image" href="#">
                            <img src="Images/image%20of%20new%20zealand/newzealandtourist3.jpg" />
                        </a>
                    </div>
                    <div>
                        <a u="image" href="#">
                            <img src="Images/image%20of%20new%20zealand/studynewzealand.jpg" />
                        </a>
                    </div>
                </div>
            ...
            <div class="body_resize">
                <div class="countryleft">
                    ...
                    <p style="text-align: left">
                        New Zealand is made up of two main islands The main North and South Islands are
                        separated by the Cook Strait The country is situated some 1,500 kilometers East
                        of Australia. New Zealand boasts a diverse natural landscape. People from all over
                        the world, travel to NZ to experience the stunning scenery and enjoy the vast range
                        of outdoor activities.
                        <br />
                        <br />
                        There are just over four million New Zealanders, and every single one is either
                        an immigrant or descended from one. In fact, people from over 145 countries now
                        call New Zealand home. It was the Mâori who first arrived here over 600 years ago,
                        followed in the 19th century by large numbers of migrants from the United Kingdom.
                        The end of World War II saw an influx of European migrants from war-weary countries
                        looking to rebuild shattered lives.<br />
                        <br />
                        Being in the Southern Hemisphere, seasons in NZ are completely opposite to countries
                        north of the equator. Winter lasts from June until August and summer is between
                        December and February. Because NZ is surrounded by sea, the climate doesn’t get
                        uncomfortably hot or unbearably cold in the areas where the majority of us live,
                        although extremes will be found, particularly in our mountain ranges in winter.
                        Overall, temperate climate ranges from 20–30°C (68–86°F) in summer, and from 5–15°C
                        (41-59°F) in winter.
                    </p>
                </div>
                <div class="countryright">
                    ...
                    <br />
                    <a href="Australia.aspx">
                        <asp:Image ID="Aus" runat="server" ImageUrl="~/VisaUser/Images/austrllia/australia-tab.jpg" />
                    </a>
                    <br />
                    <a href="Uk.aspx">
                        <asp:Image ID="uk" runat="server" ImageUrl="~/VisaUser/Images/images of uk/uk-tab.jpg" />
                    </a>
                    <br />
                    <a href="Canada.aspx">
                        <asp:Image ID="nz" runat="server" ImageUrl="~/VisaUser/Images/image of canada/canada-tab.jpg" />
                    </a>
                </div>
            </div>
        </div>
