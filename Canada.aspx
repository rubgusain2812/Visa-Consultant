<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Canada.aspx.cs" Inherits="VisaUser_canada1" %>
...
<body>
    ...
    <div id="slider2_container" style="position: relative; width: 1000px;
        height: 300px;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height: 300px;
            ...
            <div>
                <a u=image href="#">
                    <img src="Images/image%20of%20canada/home-canada.jpg"  /></a>
            </div>
            <div>
                <a u=image href="#"><img src="Images/image%20of%20canada/canada.jpg" /></a>
            </div>
            <div>
                <a u=image href="#">
                    <img src="Images/image%20of%20canada/study%20in%20canada.jpg" /></a>
            </div>
            <div>
                <a u=image href="#">
                    <img src="Images/image%20of%20canada/tourist%20canada.jpg" /></a>
            </div>
            <div>
                <a u=image href="#">
                    <img src="Images/image%20of%20canada/study%20canada.jpg" /></a>
            </div>
                    ...
                    <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1100px;
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                in India.<br /> It was my good luck that I tabbed the golden opportunity to handover my
...
handled patiently throughout the process.
        ...
        <div class="body_resize">
            ...
            <div class="countryleft">
                <h1>
                   <center> About Canada</center>
                </h1>
                <p>
                    When immigrating to Canada, one of the main things to be prepared for is the weather.
                    Most of Canada has four distinct seasons: Spring, Summer, Autumn and Winter. The
                    weather in each province can vary depending on how far north the province is, making
                    the winters colder and last longer. Canada has 10 provinces and 2 territories, each
                    with its own capital city. Depending on the location, Canada’s geography can vary
                    anywhere from agricultural land, vast mountain ranges, lakes and rivers, wilderness
                    in the far north to having one of the biggest cities in the world. Canada is also
                    known for its natural beauty, where the Canadian government has set aside more than
                    100 national parks and historic sites for tourists and residents to enjoy. Our services
                    apply to both companies and individuals and we are here to advise and guide you
                    through the maze that can sometimes be International Immigration Law. There are
                    a wide range of different types of Visas and Permits designed to best accomodate
                    your requirements. We closely examine these requirements and ensure that the route
                    we take together is the most cost effective and efficient.<br /><br />
                    Canada has been ranked as one of the world's best places to live in for the past
                    10 years by the United Nations. Some of the many reasons are the free healthcare
                    and primary and secondary school education. The education in Canada is considered
                    world class where as even the Canadian Universities are recognized as some of the
                    best universities in the world. <br />
                    <br />
                    If Canada does appeal to you and you are interested in immigrating to Canada, you
                    have a number of options when applying for permanent residence status or temporary
                    residence status. Find out more:<br /><br />
                    <b>Family Class Immigration:</b><br />
                    The person who wants to immigrate to Canada under family case must have a sponsorship
                    from a close relative who is already a permanent resident of Canada. Check for further
                    details and see if you fulfill all the criteria.<br /><br />
                    <b>Student Immigration:</b><br />
                Canada offers one of the finest education in the world thereby ensuring professional
                and personal growth of students. Check out the eligibility
            </div>
            <div class="countryright">
                <asp:Image ID="Image2" runat="server" ImageUrl="~/VisaUser/Images/image of canada/skilled-worker_top.jpg" />
                <br />
               <a href="usa.aspx"> <asp:Image ID="usa" runat="server" ImageUrl="~/VisaUser/Images/imagesOfUsa/usa-tab.jpg" /> </a>
               <br />
              
               <a href="Australia.aspx"> <asp:Image ID="Aus" runat="server" ImageUrl="~/VisaUser/Images/austrllia/australia-tab.jpg" /> </a>
                <br />
               <a href="Uk.aspx"> <asp:Image ID="uk" runat="server" ImageUrl="~/VisaUser/Images/images of uk/uk-tab.jpg" /> </a>
               <br />
               <a href="NewZealand.aspx"> <asp:Image ID="nz" runat="server" ImageUrl="~/VisaUser/Images/image of new zealand/new-zealand-tab.jpg" /> </a>
            </div>
