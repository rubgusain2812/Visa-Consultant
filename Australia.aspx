<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Australia.aspx.cs" Inherits="VisaUser_Australia" %>
...
<body>
        ...
        <div class="header">
            <div class="block_header">
                <div class="headabove" style="background-position: center center; background-image: url('http://localhost:3886/Visa-Cnslt/VisaUser/Images/manu main-bg.jpg')">
                    ...
                    <a href="Australia.aspx">    <img src="Images/austrlliawithname.png" class="imgcountytop"
                     height="40px" width="40px" />&nbsp;&nbsp;&nbsp;
                    </a>    
                    <a href="Canada.aspx">
                    <img src="Images/canadawithname.png"height="40px" class="imgcountytop"
                     width="40px" />&nbsp;&nbsp;&nbsp;
                     </a>
                     <a href="NewZealand.aspx">
                        <img src="Images/New-ZealandwithName.png"height="40px" class="imgcountytop"
                         width="40px" />&nbsp;&nbsp;&nbsp;
                        </a>
                        <a href="usa.aspx">
                        <img src="Images/usaWithName.png"height="40px" class="imgcountytop" width="40px" />&nbsp;&nbsp;&nbsp;
                        </a>
                        <a href="Uk.aspx">
                        <img src="Images/ukWithName.png" height="40px" class="imgcountytop"
                         width="40px"/>&nbsp;&nbsp;&nbsp;
                    </a>
                </div>
    ...
    <div id="slider2_container" style="position: relative; width: 1000px;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height: 300px;
            ...
            <div>
                <a u=image href="#">
                    <img src="Images/austrllia/home-australia.jpg" /></a>
            </div>
            <div>
                <a u=image href="#">
                    <img src="Images/austrllia/austrlliatouristnew.jpg" /></a>
            </div>
            <div>
                <a u=image href="#">
                    <img src="Images/austrllia/studyaustrllia.jpg" />
                    </a>
            </div>
            <div>
                <a u=image href="#">
                    <img src="Images/austrllia/austrllatourist2new.jpg" />
                    </a>
            </div>
            <div>
                <a u=image href="#">
                    <img src="Images/austrllia/Australiastudy.jpg" />
                    </a>
            </div>
        ...
        <div style="background-color: #FF0000">
            <div class="countryleft">
                ...
                <p style="text-align: left">
                    The Australian qualifications are practical oriented and commands a world-class
                    recognition and reputation throughout the world for the employment and further studies.<br /><br />
                    The Learning atmosphere encourages the student for self-learning and imparts up-to-date
                    knowledge based skills in the area of study rather than mere theoretical study.<br /><br />
                    Over 100000 international students enter Australia every year.<br /><br /> The excellence in
                    Education, the multicultural background of students, value for money, English speaking
                    country and on top of that, Governmental and institution support for international
                    students are some other aspects that has made Australia very attractive destination
                    for students from all over the world to study Australia.<br /><br /> Australia provides one
                    of the world's most meticulous consumer protection mechanism for international students.
                    Australia is a safe country compared to almost anywhere in the world. Crime and
                    political unrest are limited.
                </p>
            </div>
