<%@ Page Language="C#" AutoEventWireup="true" CodeFile="usa.aspx.cs" Inherits="VisaUser_usa" %>
        ...
        <div class="imagediv" align="center">
            ...
            <div id="slider2_container" style="position: relative; width: 1000px; height: 300px;">
                ...
                <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px;
                    ...
                    <div>
                        <a u="image" href="#">
                            <img src="Images/imagesOfUsa/usa-home.jpg" />
                        </a>
                    </div>
                    <div>
                        <a u="image" href="#">
                            <img src="Images/imagesOfUsa/usanewtourist.jpg" />
                        </a>
                    </div>
                    <div>
                        <a u="image" href="#">
                            <img src="Images/imagesOfUsa/studyusanew.png" />
                        </a>
                    </div>
                    <div>
                        <a u="image" href="#">
                            <img src="Images/imagesOfUsa/usanew2.jpg" />
                        </a>
                    </div>
                    <div>
                        <a u="image" href="#">
                            <img src="Images/imagesOfUsa/studyusanew2.jpg" />
                        </a>
                    </div>
                </div>
        ...
        <div class="body_resize">
            ...
            <div style="background-color: #FF0000">
                <div class="countryleft">
                    ...
                    <br />
                        ...
                        <ul style="text-align: left">
                            <li>One of the best things about studying in the USA is the vast number of academic
                                options offered to students.</li>
                            <li>Academic and professional programs and social activities on campuses and at corporate
                                headquarters of possible employers provide additional enrichments. For example,
                                cuisine, music, cinema and other customs are commonly shared with others during
                                the semester or academic year.</li>
                                <li>This sharing contributes to a better understanding
                                    of each other's culture. The language, skills and cross-culture environment can
                                    make the U.S. learning experience a unique and rich one.</li>
                                    <li>More and more often,
                                        American colleges and universities are focusing on the global aspects of each subject,
                                        better preparing students with a worldwide view of their field.</li>
                            <li>Most schools offer academic programs that are flexible in nature. This means that,
                                very often, one can choose when to attend classes, how many classes to enroll in
                                each semester or quarter, what elective or optional classes to take.</li>
                        </ul>
                        <br />
                         <p style="text-align: left">
                        The American education system offers international students the most diverse set
                        of education options in the world. In fact, an international student who elects
                        to take advantage of the American education system can pursue anything from nuclear
                        science to film and dance.<br />
                        <br />
                        
                        American education possibilities are almost endless! The American education system
                        requires that students complete 12 years of primary and secondary education prior
                        to attending university or college.<br /
                        <br />
                        
                        one of the most impressive facts is the large number of presidents, prime ministers
                        and leaders from other countries who have experienced the American education system
                        and graduated from a university in the USA.
                        <br />
                        <br />
                        
                        U.S. has a pool of academic institutions that are among the best in the world. The
                        quality of education is periodically reviewed by various organizations. Hence colleges
                        and universities in the US have to constantly work hard to maintain
                    </p>
                </div>
                <div class="countryright">
                    ...
                    <br />
                    <a href="Uk.aspx">
                        <asp:Image ID="usa" runat="server" ImageUrl="~/VisaUser/Images/images of uk/uk-tab.jpg" />
                    </a>
                    <br />
                    <a href="Canada.aspx">
